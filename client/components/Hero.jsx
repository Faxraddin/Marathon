    ...
    <div name='home' className='w-full h-[87vh] bg-[#06065A] text-[#fff] flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1260px] m-auto '>
            <div className='flex flex-col justify-center md:items-start w-full px-2'>
                <h1 className='py-3 text-white text-5xl not-italic font-bold leading-[70px] whitespace-nowrap'>Gələcəyi bu gün kəşf et,<br></br>Crowdfunding ilə <Typed
                    strings={['həyata keçir', 'dəstəklə', 'şərait yarat']}
                    typeSpeed={100}
                    backSpeed={100} loop
                /></h1>
